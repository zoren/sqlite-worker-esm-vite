...
// this is adapted from sqlite3-worker1-promiser-bundler-friendly.js

const defaultConfig = {
  worker: () =>
    new Worker("sqlite3-worker1-bundler-friendly.mjs", {
      type: "module",
    }),
  onerror: (...args) => console.error("worker1 promiser error", ...args),
};

export const sqlite3Worker1Promiser = (config = defaultConfig) => {
